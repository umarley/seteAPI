...
class ParametrosModel {
    ...
    public function __construct() {
        $this->_entity = new \Db\SetePG\SeteParametros();
    }
    ...
    public function getAll($codigoCidade){
        if($this->jaExisteParametrosParaCidade($codigoCidade)){
            return $this->_entity->getLista($codigoCidade);
        }else{
            $this->_entity->startupParametros($codigoCidade);
            return $this->_entity->getLista($codigoCidade);
        }
    }
    
    public function gravarValorParametro($codigoCidade, $codigoParametro, $valorParametro){
        $arIds['codigo_parametro'] = $codigoParametro;
        $arIds['codigo_cidade'] = $codigoCidade;
        return $this->_entity->_atualizar($arIds, $valorParametro);
    }
    
    private function jaExisteParametrosParaCidade($codigoCidade){
        $boParametrosCriados = $this->_entity->parametrosJaCriadosParaCidade($codigoCidade);
        return $boParametrosCriados;
    }
